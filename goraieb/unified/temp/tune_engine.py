...
def build_params(coarse=False):
    ...
    return [
        ...
        Parameter("doubled_penalty",  0.0,  35.0,  step=3.0*s),
        Parameter("isolated_penalty", 0.0,  25.0,  step=3.0*s),
        Parameter("backward_penalty", 0.0,  25.0,  step=3.0*s),

        # Rook placement
        Parameter("rook_open_file",   0.0,  35.0,  step=5.0*s),
        Parameter("rook_semi_open",   0.0,  20.0,  step=3.0*s),
        Parameter("rook_doubled_file",0.0,  20.0,  step=3.0*s),
        Parameter("connected_rooks",  0.0,  35.0,  step=5.0*s),
        ...
        Parameter("uncastled_king",   0.0,  40.0,  step=3.0*s),

        # Piece activity
        Parameter("mobility",        0.0,   5.0,  step=0.25*s),
        Parameter("bishop_pair",    0.0,  50.0,  step=5.0*s),
        Parameter("knight_outpost",   0.0,  45.0,  step=5.0*s),
        Parameter("king_tropism",     0.0,  8.0,   step=1.0*s),

        # Tactical awareness
        Parameter("hanging_piece",   0.0,  70.0,  step=5.0*s),
        Parameter("pin_penalty",     0.0,  50.0,  step=5.0*s),

        # Development / positional
        Parameter("center_control",   0.0,  20.0,  step=2.0*s),
        Parameter("early_queen_pen",  0.0,  40.0,  step=5.0*s),
        Parameter("development",      0.0,  20.0,  step=3.0*s),
        Parameter("tempo",            0.0,  15.0,  step=2.0*s),
        Parameter("overextended_piece",   0.0,  70.0,  step=5.0*s),
